...
urlpatterns = [
    ...
    path('student/home/courses/',student_views.student_courses, name = "student_courses"),
    path('student/home/fellowships/',student_views.student_fellowships, name = "student_fellowships"),
    path('student/home/internships/',student_views.student_internships, name = "student_internships"),
    ...
    path("staff/view/notification/", staff_views.staff_view_notification,
     ...
     #Adding Model for test generation

     # path('staff/view/test_generation/',staff_views.test_generate,name = 'test_generate')
